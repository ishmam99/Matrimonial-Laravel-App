...
@section('content')
  <div class="card card-custom card-sticky" id="kt_page_sticky_card">
    ...
    <div class="card-body">
      ...
      @endif
      <form class="form" id="kt_form" method="post" action="{{ route('profileStatusBoostPackages.update',$profileStatusBoostPackage->id) }}" enctype="multipart/form-data">
        @method('PUT')
        @csrf
        <div class="row justify-content-center">
          <div class="col-lg-10">
            <div class="my-5">
              ...
              <div class="form-group row">
                <label class="col-md-2 col-form-label" for="image">Package Name <span class="text-danger">*</span></label>
                <div class="col-md-10">
                  <input name="name" id="name" value="{{$profileStatusBoostPackage->name }}" class="form-control form-control-solid @error('name') is-invalid @enderror" type="text">
                  @error('name')
                  <div class="text-danger">{{ $message }}</div>
                  @enderror
                </div>
              ...
              <div class="form-group row">
                <label class="col-md-2 col-form-label" for="price">Price <span class="text-danger">*</span></label>
                <div class="col-md-10">
                  <input name="price" id="price" type="number" value="{{$profileStatusBoostPackage->price }}" class="form-control form-control-solid @error('price') is-invalid @enderror" >
                  @error('price')
                  <div class="text-danger">{{ $message }}</div>
                  @enderror
                </div>
              ...
              <div class="form-group row">
                <label class="col-md-2 col-form-label" for="discount">Discount <span class="text-danger">*</span></label>
                <div class="col-md-10">
                  <input name="discount" id="discount" value="{{$profileStatusBoostPackage->discount }}" class="form-control form-control-solid @error('discount') is-invalid @enderror" type="number">
                  @error('discount')
                  <div class="text-danger">{{ $message }}</div>
                  @enderror
                </div>
             ...
             <div class="form-group row">
                ...
                <div class="col-md-10">
                 <select name="type" class="form-control" id="type">
                   <option value="0" {{$profileStatusBoostPackage->type ==0 ? 'selected':''}}>Profile Boost Package</option>
                    <option value="1" {{$profileStatusBoostPackage->type ==1 ? 'selected':''}}>Status Boost Package</option>
                 </select>
                  @error('type')
                  <div class="text-danger">{{ $message }}</div>
                  @enderror
              ...
              <div class="form-group row">
                ...
                <div class="col-md-10">
                 <select name="duration" class="form-control" id="duration">
                  <option value="0" {{$profileStatusBoostPackage->duration ==0 ? 'selected':''}}>1 week</option>
                  <option value="1" {{$profileStatusBoostPackage->duration ==1 ? 'selected':''}}>15 days</option>
                  <option value="2" {{$profileStatusBoostPackage->duration ==2 ? 'selected':''}}>1 month</option>
                  <option value="3" {{$profileStatusBoostPackage->duration ==3 ? 'selected':''}}>3 months</option>
                  <option value="4" {{$profileStatusBoostPackage->duration ==4 ? 'selected':''}}>6 months</option>
                  <option value="5" {{$profileStatusBoostPackage->duration ==5 ? 'selected':''}}>1 year</option>
                 </select>
                  @error('type')
                  <div class="text-danger">{{ $message }}</div>
                  @enderror
              ...
              <div class="form-group row">
                <label class="col-md-2 col-form-label" for="details">Details <span class="text-danger">*</span></label>
                <div class="col-md-10">
                  <textarea name="details" id="details" class="form-control form-control-solid @error('details') is-invalid @enderror">{{ old('details',$profileStatusBoostPackage->details) }}</textarea>
                  @error('details')
                  <div class="text-danger">{{ $message }}</div>
                  @enderror
                </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-10">
                  ...
                  <span class="switch switch-icon">
                    ...
                    <input type="checkbox" {{ $profileStatusBoostPackage->status == 0 ? 'checked' : '' }} value="0" name="status"/>
                      <span></span>
                    </label>
                  </span>
                </div>
