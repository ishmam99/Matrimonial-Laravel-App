      ...
      <div class="card card-custom card-stretch">
        <div class="card-header py-3">
          <div class="card-title align-items-start flex-column">
            <h3 class="card-label font-weight-bolder text-dark">Kazi Information</h3>
         
          </div>
          <div class="card-toolbar">
              <a href="{{route('kazi.contracts',$kazi->id)}}"><button type="submit" class="btn btn-primary mr-2" >Case List</button></a> 
               <a href="{{route('kazi.edit',$kazi->id)}}"><button type="submit" class="btn btn-success mr-2" >Edit Kazi</button></a> 
        ...
        <div class="card-body">
            ...
            <div class="col-6 ">
                ...
                <div class="row ">
                  ...
                  <div class="col-xl-6 col-lg-6 col-form-label text-left">
                    <h5>{{$kazi->contracts->where('status',App\Models\UserKazi::RUNNING)->count()}}</h5>
                  </div>
                  <label class="col-xl-4 col-lg-4 col-form-label" for="name"> Hold Cases : </label>
                  <div class="col-xl-6 col-lg-6 col-form-label text-left">
                    <h5>{{$kazi->contracts->where('status',App\Models\UserKazi::HOLD)->count()}}</h5>
                  </div>
                  <label class="col-xl-4 col-lg-4 col-form-label" for="name"> Pending Cases : </label>
                  <div class="col-xl-6 col-lg-6 col-form-label text-left">
                    <h5>{{$kazi->contracts->where('status',App\Models\UserKazi::PENDING)->count()}}</h5>
                  </div>
                  <label class="col-xl-4 col-lg-4 col-form-label" for="name"> Dismissed Cases : </label>
                  <div class="col-xl-6 col-lg-6 col-form-label text-left">
                    <h5>{{$kazi->contracts->where('status',App\Models\UserKazi::DISMISSED)->count()}}</h5>
                  </div>
                  <label class="col-xl-4 col-lg-4 col-form-label" for="name"> Closed Cases : </label>
                  <div class="col-xl-6 col-lg-6 col-form-label text-left">
                    <h5>{{$kazi->contracts->where('status',App\Models\UserKazi::CLOSED)->count()}}</h5>
                  </div></div>
            </div></div>  @php
                        $total= $kazi->user->reviews->count();
                        $totals = $kazi->user->reviews->sum('rating')/5;
                      if($kazi->reviews){
            ...
            <div class="col-6">
                <div class="bg-white rounded shadow-sm p-4 mb-4 clearfix graph-star-rating">
                    ...
                    <div class="graph-star-rating-header">
                        <div class="star-rating">
                            ...
                            <a href="#"><i class="icofont-ui-rating active"></i></a>
                            <a href="#"><i class="icofont-ui-rating active"></i></a>
                            <a href="#"><i class="icofont-ui-rating"></i></a> <b class="text-black ml-2">Total {{$kazi->user->reviews->count()}}</b>
                        </div>
              ...
              <div class="bg-white rounded shadow-sm p-4 mb-4 restaurant-detailed-ratings-and-reviews col-12">
                    ...
                    @foreach ($kazi->user->reviews->load('profile') as $review)
