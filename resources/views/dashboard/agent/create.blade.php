      ...
      <div class="card card-custom card-stretch">
        <div class="card-header py-3">
          <div class="card-title align-items-start flex-column">
            <h3 class="card-label font-weight-bolder text-dark">Create New Agent</h3>
            <span class="text-muted font-weight-bold font-size-sm mt-1">Insert Agent personal information</span>
          </div>
        ...
        <form class="form" action="{{ route('user.store') }}" id="profile_create_form" method="post" enctype="multipart/form-data">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-12">
                <h5 class="font-weight-bold mb-6">Agent Info</h5>
              </div>
            </div>
            ...
            <div class="form-group row">
              <label class="col-xl-3 col-lg-3 col-form-label" for="phone">Agent Category</label>
              <div class="col-lg-9 col-xl-6">
                <select class="form-control form-control-lg form-control-solid" name="category" required>
                  @foreach (App\Models\AgentCategory::all() as $cat)
