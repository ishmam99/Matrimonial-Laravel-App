            ...
            @foreach($users as $user)
              <tr>
                ...
                <td>@if ($user->status == App\Models\User::PENDING)
                    <a href="{{route('lawyer.accept',$user->id)}}"><button class="btn btn-danger">Pending</button></a>
                @else
                ...
                <td nowrap="nowrap">
                  ...
                  <a href="{{route('lawyer.show',$user->id)}}" class="btn btn-icon btn-light btn-hover-success btn-sm mx-3">
