    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">Notice List</h3>
            </div>
                            ...
                            <tr>
                                ...
                                <td nowrap="nowrap">
                                    @can('web_content.edit')
                                        <a href="{{ route('notice.edit', $notice->id) }}" class="btn btn-icon btn-light btn-hover-primary btn-sm mr-2">
                                    ...
                                    @can('web_content.delete')
                                        <form method="post" action="{{ route('notice.destroy', $notice->id) }}" class="d-inline-block">
                                            @csrf
                                            @method('DELETE')
