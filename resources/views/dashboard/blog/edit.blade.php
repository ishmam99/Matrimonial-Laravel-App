            ...
            <div class="my-5">
              ...
              <div class="form-group row">
                <div class="col-md-10 offset-md-2">
                  <img src="{{ setImage($blog->image) }}" alt="" style="width: 200px">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-10">
                  <textarea name="content" id="content" class="form-control form-control-solid @error('content') is-invalid @enderror">{{ old('content', $blog->content) }}</textarea>
                  @error('content')
                  <div class="text-danger">{{ $message }}</div>
                  @enderror
                </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-10">
                  ...
                  <label>
                    <input type="checkbox" {{ $blog->status == 1 ? 'checked' : '' }} value="1" name="status"/>
                    <span></span>
                  </label>
                </span>
                </div>
