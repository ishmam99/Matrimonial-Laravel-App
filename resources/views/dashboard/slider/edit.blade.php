...
@section('content')
  <div class="card card-custom card-sticky" id="kt_page_sticky_card">
    ...
    <div class="card-body">
      <!--begin::Form-->
      <form class="form" id="kt_form" method="post" action="{{ route('slider.update',$slider->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            ...
            <div class="my-5">
              ...
              <div class="form-group row">
                <div class="col-md-10 offset-md-2">
                  <img src="{{ setImage($slider->image) }}" alt="" style="width: 200px">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-10">
                  ...
                  <label>
                    <input type="checkbox" {{ $slider->status == 0 ? 'checked' : '' }} value="0" name="status"/>
                    <span></span>
                  </label>
                </span>
                </div>
