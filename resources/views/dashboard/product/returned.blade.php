  ...
  <div class="card card-custom">
    ...
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
      <div class="card-title">
        <h3 class="card-label">Product Return List</h3>
      </div>
            ...
            @foreach($list as $item)
              <tr>
               ...
               <td>{{ $item->profile->name}}</td>
                <td>{{ $item->order->product->title }}Tk</td>
                ...
                <td nowrap="nowrap">
                  ...
                  <form method="post" action="{{ route('productReturn.destroy', $item->id) }}" class="d-inline-block">
                    @csrf
                    @method('DELETE')
                  ...
                  <a href="{{ route('productReturn.show', $item->id) }}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-2">
                    <span class="svg-icon svg-icon-md svg-icon-primary">
