          ...
          <div class="col-xl-12">
            <div class="my-5">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-10">
                  <input name="image_one" id="image_one" value="{{ old('image_one') }}" class="form-control form-control-solid @error('image_one') is-invalid @enderror" type="file" required>
                  @error('image')
               ...
               <div class="form-group row">
                <label class="col-md-2 col-form-label" for="image_two">Image <span class="text-danger">*</span></label>
                <div class="col-md-10">
                  <input name="image_two" id="image_two" value="{{ old('image_two') }}" class="form-control form-control-solid @error('image_two') is-invalid @enderror" type="file" >
                  @error('image_two')
                  <div class="text-danger">{{ $message }}</div>
                  @enderror
                </div>
               ...
               <div class="form-group row">
                <label class="col-md-2 col-form-label" for="image_three">Image <span class="text-danger">*</span></label>
                <div class="col-md-10">
                  <input name="image_three" id="image_three" value="{{ old('image_three') }}" class="form-control form-control-solid @error('image_three') is-invalid @enderror" type="file" >
                  @error('image_three')
                  <div class="text-danger">{{ $message }}</div>
                  @enderror
                </div>
               ...
               <div class="form-group row">
                <label class="col-md-2 col-form-label" for="image_four">Image <span class="text-danger">*</span></label>
                <div class="col-md-10">
                  <input name="image_four" id="image_four" value="{{ old('image_four') }}" class="form-control form-control-solid @error('image_four') is-invalid @enderror" type="file" >
                  @error('image_four')
                  <div class="text-danger">{{ $message }}</div>
                  @enderror
                </div>
              ...
              <div class="form-group row">
               ...
               <div class="form-group row">
                ...
                <div class="col-md-10">
                  <input name="stock" id="stock" value="{{ old('stock') }}" class="form-control form-control-solid @error('stock') is-invalid @enderror" type="number" step="0.01">
                  @error('stock')
                  <div class="text-danger">{{ $message }}</div>
                  @enderror
                </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-10">
                  <input name="percentage" id="percentage" value="{{ old('percentage') }}" class="form-control form-control-solid @error('percentage') is-invalid @enderror" type="number" step="0.01">
                  @error('percentage')
                  <div class="text-danger">{{ $message }}</div>
                  @enderror
                </div>
