          ...
          <tbody>
            @foreach($products as $product)
              <tr>
                <td>{{ $product->sl }}</td>
                <td>
                 <img src="{{setImage($product->image_one)}}" width="50px" alt="">
                </td>
                <td>{{ $product->price }}Tk</td>
                <td>{{ $product->stock }}</td>
                <td>{{ $product->title }}</td>
                <td>{{ $product->status ? 'Published' : 'Unpublished' }}</td>
                <td>{{$product->productReviews->count()}}</td>
                <td nowrap="nowrap">
                  ...
                  <a href="{{ route('product.show', $product->id) }}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-2">
                    <span class="svg-icon svg-icon-md svg-icon-primary">
