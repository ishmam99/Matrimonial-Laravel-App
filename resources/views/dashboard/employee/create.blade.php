      ...
      <div class="card card-custom card-stretch">
        <div class="card-header py-3">
          <div class="card-title align-items-start flex-column">
            <h3 class="card-label font-weight-bolder text-dark">Create New Employee</h3>
            <span class="text-muted font-weight-bold font-size-sm mt-1">Insert User personal information</span>
          </div>
        ...
        <form class="form" action="{{ route('user.store') }}" id="profile_create_form" method="post" enctype="multipart/form-data">
          ...
          <div class="card-body">
            ...
            <div class="form-group row">
              <label class="col-xl-3 col-lg-3 col-form-label" for="phone">Employee Post</label>
              <div class="col-lg-9 col-xl-6">
                <select class="form-control form-control-lg form-control-solid" name="post">
               
                 <option id="1" value="{{App\Models\Employee::EMPLOYEE}}">Employee</option>
                  <option id="2" value="{{App\Models\Employee::MANAGER}}">Manager </option>
                  {{-- <option id="3" value="{{App\Models\User::KAZI}}">Kazi </option> --}}
                  {{-- <option id="4" value="{{App\Models\User::EMPLOYEE}}">Employee </option> --}}
                  {{-- <option id="5" value="{{App\Models\User::SPONSOR}}">Sponsor </option> --}}
                  {{-- <option id="6" value="{{App\Models\User::AGENT}}">Agent </option> --}}
