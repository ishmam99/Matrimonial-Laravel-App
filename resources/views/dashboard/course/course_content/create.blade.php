...
@section('content')
  ...
  <div class="card card-custom card-sticky" id="kt_page_sticky_card">
    ...
    <div class="card-body" style="background-color: wheat">
      <!--begin::Form-->
      <form class="form" id="kt_form" method="post" action="{{ route('contentMedia.store') }}" enctype="multipart/form-data">
        @csrf
        <div class="row">
          ...
          <div class="col-xl-8">
            <div class="my-5">
              ...
              <div class="form-group row">
                <label class="col-md-3 col-form-label" for="name">Link&nbsp;<span class="text-danger">*</span></label>
                <div class="col-md-9">
                  <input name="link" id="link" value="{{ old('link') }}" class="form-control form-control-solid @error('link') is-invalid @enderror" type="url" >
                  @error('link')
                  <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
              ...
              <div class="form-group row">
                <label class="col-md-3 col-form-label" for="name">Video&nbsp;<span class="text-danger">*</span></label>
                <div class="col-md-9">
                  <input name="media" id="media" value="{{ old('media') }}" class="form-control form-control-solid @error('media') is-invalid @enderror" type="file" >
                  @error('media')
                  <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
