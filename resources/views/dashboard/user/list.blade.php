            ...
            @foreach($users as $user)
              <tr>
                ...
                <td>@if ($user->status == App\Models\User::PENDING)
                    <a href="{{route('users.accept',$user->id)}}"><button class="btn btn-danger">Pending</button></a>
                @else
                ...
                <td nowrap="nowrap">
                  ...
                  <a href="{{route('user.show',$user->id)}}" class="btn btn-icon btn-light btn-hover-success btn-sm mx-3">
