...
@section('content')
  ...
  <div class="card card-custom card-sticky" id="kt_page_sticky_card">
    ...
    <div class="card-body">
      <!--begin::Form-->
      <form class="form" id="kt_form" method="post" action="{{ route('faq.store') }}">
        @csrf
          ...
          <div class="col-xl-8">
            <div class="my-5">
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <input name="question" id="question" value="{{ old('question') }}" class="form-control form-control-solid @error('question') is-invalid @enderror" type="text" required>
                  @error('question')
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <textarea name="answer" id="answer" rows="5" class="form-control form-control-solid @error('answer') is-invalid @enderror" required>{{ old('answer') }}</textarea>
                  @error('answer')
                  <div class="text-danger">{{ $message }}</div>
                  @enderror
                </div>
