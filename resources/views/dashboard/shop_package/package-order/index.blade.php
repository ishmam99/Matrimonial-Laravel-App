  ...
  <div class="card card-custom">
    ...
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
      <div class="card-title">
        <h3 class="card-label">Package Order order</h3>
      </div>
    </div>
    <div class="card-body">
            ...
            @foreach($orders as $order)
              <tr>
                ...
                <td nowrap="nowrap">
                    ...
                    <a href="{{ route('shopPackage.order-view', $order->id) }}" class="btn btn-icon btn-light btn-hover-primary btn-sm">
